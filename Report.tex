...
\chapter{Conclusion}
Talented young minds all over the world are contributing for the revolutions in technology. 
The youths of Nepal and their enthusiasm are equally competent and are involved in changing the society through technology. 
The engineering students of Nepal reflect great potential when it comes to a field like Robotics and Artificial intelligence and in 
paving the ways of new possibilities.

However, the fact that many such potential and talented ones in context of our country get dejected 
and rather seek to capitalize their skills elsewhere. It has been slogan that “There is no scope in Nepal” is really disheartening but true. 
However, in amidst of all these darkness, Paaila Technology has proved to be an exemplary effort that has brought that hope of light and inspiration 
to youths of Nepal to believe that “Nepali youths are in no means less than others when it comes to technological developments specially in the field of 
AI and Robotics.” The vision of bringing mass production of machines to Nepal is what Paila technology possesses and drives for. 
They are one of the few companies who can, if successful, effectively create satisfying jobs for many robotic enthusiasts in Nepal currently 
looking for opportunities elsewhere. Visiting such emerging company in the arena of the robotic revolution is itself an extraordinary door 
for us to look through how and what is essential to build the managerial aspects of any company. The ongoing management and the adaptable 
development course of the organization under microscopic vision taught us how we would be coping and solving the relevant problems in near
 future working for the company or establishing one. 
 
 After weeks of study and analysis we concluded that proper organizational plans and artistic managerial aspects lead the company to its fortune to achieve the milestones. Thus, in a nutshell, the visit has clearly helped us a great deal to comprehend core ideas related to our course of study on “Organization and Management”.
\begin{thebibliography}{9}

  \bibitem{notes} \textit{About us}. Retrieved from http://paailatechnology.com/

  \bibitem{glocal} Khabar, Glocal. (2017, July 14). \textit{This squad of young engineers is striving towards
commercial future of robotics in Nepal: Story of Paaila Technology}. Retrieved from https://glocalkhabar.com/featured/squad-young-engineers-striving-towards-commercial-future-robotics-nepal-story-paaila-technology/

  \bibitem{Bajracharya} Bajracharya, Dikchhyanta. (2017, Aug 24). \textit{The Journey of Paaila Technology}. Retrieved from http://startupsnepal.com/stories/entry/the-journey-of-paaila-technology-a-kathmandu-based-tech-startup-that-is-taking-the-nepali-automation-scene-by-storm-with-pari
  \end{thebibliography}
\end{document}
